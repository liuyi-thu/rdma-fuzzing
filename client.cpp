...
int main(int argc, char** argv){
    ...
    printf("[20] ModifySRQ(srq=srq0, attr_var=srq_attr_srq0, attr_obj=IbvSrqAttr{max_wr=1024, max_sge=1}, attr_mask=0) start.\n");
    ...
    printf("[21] PostSRQRecv(srq=srq0, wr_obj=IbvRecvWR{num_sge=1, sg_list=[IbvSge x1: IbvSge{addr=∅, length=∅, lkey=∅}], wr_id=1}, wr_var=recv_wr_srq0, bad_wr_var=bad_recv_wr_srq0) start.\n");
    ...
    printf("[23] DestroyQP(qp=qp0) start.\n");
    ...
    printf("[25] DestroySRQ(srq=srq0) start.\n");
    ...
    printf("[26] DeregMR(mr=mr0) start.\n");
    ...
    printf("[27] DeallocPD(pd=pd0) start.\n");
