...
class AckCQEvents(VerbCall):
    ...
    def __init__(self, cq: str, nevents: int):
        self.cq = cq
    ...
    def apply(self, ctx: CodeGenContext):
        ...
        if self.tracker:
            self.tracker.use("cq", self.cq)  # 明确追踪这个CQ被使用了一次
            self.required_resources.append(("cq", self.cq))  # 记录需要的资源
...
class AdviseMR(VerbCall):
    ...
    def __init__(self, pd: str, advice: int, flags: int, sg_list: list, num_sge: int = None, sg_var: str = "sg_list"):
        self.pd = pd
        self.advice = advice
        self.flags = flags
    ...
    def apply(self, ctx: CodeGenContext):
        ...
        if self.tracker:
            ...
            self.required_resources.append(("pd", self.pd))  # 记录需要的资源
...
class AllocDM(VerbCall):
    def __init__(self, dm: str, attr_obj=None):
        self.dm = dm
    ...
    def apply(self, ctx: CodeGenContext):
        ...
        if self.tracker:
            ...
            # self.required_resources.append(('dm', self.dm))  # 记录需要的资源
            self.allocated_resources.append(("dm", self.dm))  # 记录已分配的资源
...
class AllocMW(VerbCall):
    def __init__(self, pd, mw, mw_type="IBV_MW_TYPE_1"):
        self.pd = pd
        self.mw = mw
    ...
    def apply(self, ctx: CodeGenContext):
        ...
        if self.tracker:
            self.tracker.use("pd", self.pd)
            self.tracker.create("mw", self.mw, pd=self.pd)
...
class AllocNullMR(VerbCall):
    ...
    def apply(self, ctx: CodeGenContext):
        ...
        if self.tracker:
            ...
            self.tracker.create("mr", self.mr, pd=self.pd)
            self.allocated_resources.append(("mr", self.mr))  # 记录已分配的资源
            self.required_resources.append(("pd", self.pd))  # 记录需要的资源
...
class AllocParentDomain(VerbCall):
    ...
    def __init__(self, context=None, pd: str = None, parent_pd: str = None, attr_var: str = None, attr_obj=None):
...
class AllocTD(VerbCall):
    ...
    def apply(self, ctx: CodeGenContext):
        ...
        if self.tracker:
            ...
            # self.required_resources.append(('td', self.td))  # 记录需要的资源（神志不清了）
...
class AttachMcast(VerbCall):
    ...
    def apply(self, ctx: CodeGenContext):
        ...
        if self.tracker:
            ...
            self.required_resources.append(("qp", self.qp))  # 记录需要的资源
...
class BindMW(VerbCall):
    ...
    def apply(self, ctx: CodeGenContext):
        ...
        if self.tracker:
            ...
            self.required_resources.append(("qp", self.qp))  # 记录需要的资源
            self.required_resources.append(("mr", self.mw_bind_obj.mr))  # 记录需要的资源
            self.allocated_resources.append(("mw", self.mw))  # 记录已分配的资源
...
class CloseXRCD(VerbCall):
    ...
    def apply(self, ctx: CodeGenContext):
        ...
        if self.tracker:
            ...
            self.required_resources.append(("xrcd", self.xrcd))
...
class CreateAHFromWC(VerbCall):
    ...
    def apply(self, ctx: CodeGenContext):
        ...
        if self.tracker:
            ...
            self.required_resources.append(("pd", self.pd))  # 记录需要的资源
            self.required_resources.append(("wc", self.wc))
            self.required_resources.append(("grh", self.grh))  # 记录需要的资源
    ...
    def apply(self, ctx: CodeGenContext):
        ...
        if self.tracker:
            ...
            if self.cq_attr_obj.parent_domain:
                ...
                self.required_resources.append(("pd", self.cq_attr_obj.parent_domain))  # 记录需要的资源
...
class CreateQP(VerbCall):
    ...
    def apply(self, ctx: CodeGenContext):
        ...
        if self.tracker:
            ...
            self.tracker.use("cq", self.init_attr_obj.send_cq if self.init_attr_obj else None)
            self.tracker.use("cq", self.init_attr_obj.recv_cq if self.init_attr_obj else None)
            self.tracker.use("srq", self.init_attr_obj.srq if self.init_attr_obj else None)
            self.required_resources.append(("pd", self.pd))  # 记录需要的资源
            # self.required_resources.append(('qp', self.qp))
            if self.init_attr_obj:
                self.required_resources.append(("cq", self.init_attr_obj.send_cq))
                self.required_resources.append(("cq", self.init_attr_obj.recv_cq))
                self.required_resources.append(("srq", self.init_attr_obj.srq))
...
class CreateQPEx(VerbCall):
    ...
    def apply(self, ctx: CodeGenContext):
        ...
        if self.tracker:
            ...
            self.tracker.use("cq", self.qp_attr_obj.send_cq if self.qp_attr_obj else None)
            self.tracker.use("cq", self.qp_attr_obj.recv_cq if self.qp_attr_obj else None)
            ...
            # self.required_resources.append(('qp', self.qp))  # 记录需要的资源
            if self.qp_attr_obj:
                self.required_resources.append(("cq", self.qp_attr_obj.send_cq))
                self.required_resources.append(("cq", self.qp_attr_obj.recv_cq))
                self.required_resources.append(("srq", self.qp_attr_obj.srq))
                self.required_resources.append(("pd", self.qp_attr_obj.pd))
                self.required_resources.append(("xrcd", self.qp_attr_obj.xrcd))
...
class CreateSRQEx(VerbCall):
    ...
    def apply(self, ctx: CodeGenContext):
        ...
        if self.tracker:
            ...
            self.tracker.use("xrcd", self.srq_attr_obj.xrcd if self.srq_attr_obj else None)
            self.required_resources.append(
                ("pd", self.srq_attr_obj.pd if self.srq_attr_obj else None)
            )  # 记录需要的资源
            self.required_resources.append(("cq", self.srq_attr_obj.cq if self.srq_attr_obj else None))
            self.required_resources.append(("xrcd", self.srq_attr_obj.xrcd if self.srq_attr_obj else None))
...
class CreateWQ(VerbCall):
    ...
    def apply(self, ctx: CodeGenContext):
        ...
        if self.tracker:
            ...
            self.required_resources.append(("pd", self.wq_attr_obj.pd if self.wq_attr_obj else None))  # 记录需要的资源
            self.required_resources.append(("cq", self.wq_attr_obj.cq if self.wq_attr_obj else None))
            # self.required_resources.append(('wq', self.wq))
...
class DeallocMW(VerbCall):
    ...
    def apply(self, ctx: CodeGenContext):
        ...
        if self.tracker:
            ...
            self.required_resources.append(("mw", self.mw))  # 记录需要的资源
...
class DeallocTD(VerbCall):
    ...
    def apply(self, ctx: CodeGenContext):
        ...
        if self.tracker:
            ...
            self.required_resources.append(("td", self.td))
...
class DeregMR(VerbCall):
    ...
    def apply(self, ctx: CodeGenContext):
        ...
        if self.tracker:
            ...
            self.required_resources.append(("mr", self.mr))
...
class DestroyAH(VerbCall):
    ...
    def apply(self, ctx: CodeGenContext):
        ...
        if self.tracker:
            ...
            self.required_resources.append(("ah", self.ah))  # 记录需要的资源
...
class DestroyCompChannel(VerbCall):
    ...
    def apply(self, ctx: CodeGenContext):
        ...
        if self.tracker:
            ...
            self.required_resources.append(("comp_channel", self.comp_channel))  # 记录需要的资源
...
class DestroyFlow(VerbCall):
    ...
    def apply(self, ctx: CodeGenContext):
        ...
        if self.tracker:
            ...
            self.required_resources.append(("flow", self.flow))  # 记录需要的资源
...
class DestroySRQ(VerbCall):
    ...
    def apply(self, ctx: CodeGenContext):
        ...
        if self.tracker:
            ...
            self.required_resources.append(("srq", self.srq))  # 记录需要的资源
...
class DestroyWQ(VerbCall):
    ...
    def apply(self, ctx: CodeGenContext):
        ...
        if self.tracker:
            ...
            self.required_resources.append(("wq", self.wq))  # 记录需要的资源
...
class ModifySRQ(VerbCall):
    ...
    def apply(self, ctx: CodeGenContext):
        ...
        if self.tracker:
            # Register the SRQ address in the tracker
            self.tracker.use("srq", self.srq)
            self.required_resources.append(("srq", self.srq))
...
class OpenQP(VerbCall):
    ...
    def apply(self, ctx: CodeGenContext):
        ...
        if self.tracker:
            ...
            self.required_resources.append(("qp", self.qp))  # 记录需要的资源
            self.required_resources.append(("xrcd", self.attr_obj.xrcd if self.attr_obj else None))  # 记录需要的资源
            # # Register the context variable in the tracker
...
class OpenXRCD(VerbCall):
    ...
    def apply(self, ctx: CodeGenContext):
        ...
        if self.tracker:
            ...
            self.tracker.use("xrcd", self.xrcd)
            self.required_resources.append(("xrcd", self.xrcd))  # 记录需要的资源
...
class RegDmaBufMR(VerbCall):
    ...
    def apply(self, ctx: CodeGenContext):
        ...
        if self.tracker:
            ...
            self.tracker.use("pd", self.pd)
            self.tracker.create("mr", self.mr)
            self.required_resources.append(("pd", self.pd))
            self.allocated_resources.append(("mr", self.mr))  # 记录需要的资源
...
class ReRegMR(VerbCall):
    ...
    def apply(self, ctx: CodeGenContext):
        ...
        if self.tracker:
            # Register the MR address in the tracker
            self.tracker.use("mr", self.mr)
            self.required_resources.append(("mr", self.mr))  # 记录需要的资源
...
class AbortWR(VerbCall):
    ...
    def apply(self, ctx: CodeGenContext):
        ...
        if self.tracker:
            ...
            self.required_resources.append(("qp_ex", self.qp_ex))  # 记录需要的资源
