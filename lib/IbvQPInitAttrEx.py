...
class IbvQPInitAttrEx:
    FIELD_LIST = [
        "qp_context", "send_cq", "recv_cq", "srq", "cap", "qp_type",
        "sq_sig_all", "comp_mask", "pd", "xrcd", "create_flags", "max_tso_header",
        "rwq_ind_tbl", "rx_hash_conf", "source_qpn", "send_ops_flags"
    ]
    def __init__(self, qp_context=None, send_cq=None, recv_cq=None, srq=None, cap=None, qp_type=None,
                 sq_sig_all=None, comp_mask=None, pd=None, xrcd=None, create_flags=None, max_tso_header=None,
                 rwq_ind_tbl=None, rx_hash_conf=None, source_qpn=None, send_ops_flags=None):
